...
export const mockNews: News[] = [
  {
    id: '1',
    title: '第2回 ヘルスケアDXカンファレンスを開催しました',
    category: 'イベント',
    publishedAt: '2026-01-28T10:00:00.000Z',
    content: '2026年1月28日、第2回ヘルスケアDXカンファレンスを開催しました。医療・介護現場におけるデジタル活用の最新事例を共有し、多くの方にご参加いただきました。',
    createdAt: '2026-01-28T10:00:00.000Z',
    updatedAt: '2026-01-28T10:00:00.000Z',
  },
  {
    id: '2',
    title: 'DXアシスタントCUPを開催しました',
    category: 'イベント',
    publishedAt: '2026-01-15T10:00:00.000Z',
    content: '職員を対象としたDXアシスタントCUPを開催しました。日頃の業務改善アイデアを競い合い、現場発のDX推進を盛り上げました。',
